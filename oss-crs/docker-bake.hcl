# =============================================================================
# crs-bug-finding-claude-code Docker Bake Configuration
# =============================================================================
#
...
group "prepare" {
  targets = ["claude-code-bug-finding-base"]
}
...
target "claude-code-bug-finding-base" {
  context    = "."
  dockerfile = "oss-crs/base.Dockerfile"
  tags       = tags("claude-code-bug-finding-base")
}
